  ...
  return (
    <View style={styles.main}>
      ...
      <View style={styles.box}>
        ...
        <TouchableOpacity onPress={() => navigation.navigate('Register')} style={{ width: '50%', alignSelf: 'flex-end' }}>
...
const styles = StyleSheet.create({
  ...
  login:{
    width: '100%', alignSelf: 'center', marginTop: 20, backgroundColor: '#1A73E8', paddingVertical: 10, borderRadius: 6 
  }
})